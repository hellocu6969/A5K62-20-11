...
const defaultHeartImages = Array.from({ length: 100 }, (_, i) => `images/img${i + 1}.jpg`);
...
const ringTexts = [
  ...
  " Tháng 11 về mang theo những kí ức dịu dàng, những tình cảm ấm áp riêng biệt của cô và chúng em.",
"Trong khoảnh khắc thiêng liêng này, em xin gửi đến cô lời tri ân chân thành và sâu sắc nhất.",
 "Cảm ơn cô vì đã là người dẫn dắt, người truyền cảm hứng đặc biệt. Cảm ơn vì cô đã luôn tận tâm, ",
" kiên nhẫn và truyền cho em những bài học không chỉ trên trang sách mà cả trong cuộc sống. ",
 "Cảm ơn cô vì tất cả những điều cô đã làm, đã trao gửi và hi sinh. Chúc cô luôn mạnh khỏe,",
 "hạnh phúc và tiếp tục thắp sáng ngọn lửa tri thức cho bao thế hệ học trò.,",
...
function createTextRings() {
  ...
  for (let i = 0; i < numRings; i++) {
    ...
    ringGroup.userData = {
      ...
      speed: 0.00005 + 0.000005, // Tốc độ quay
